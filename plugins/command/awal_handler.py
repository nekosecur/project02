...
async def status_handler(client: Client, msg: types.Message):
    ...
    # Load the image
    image = Image.open('infinitymenfess.jpg')  # Replace with the actual image path
...
async def help_handler(client, msg):
    ...
    pesan += '#InfinityBoy / #InfinityGirl untuk Mencari Pasangan,Teman , Partner dll #InfinityAsk untuk Bertanya #InfinityStory untuk Berbagi Cerita #InfinitySpill untuk Spill Masalah #InfinityFind untuk Mencari Pasangan, Teman, Partner dll'
